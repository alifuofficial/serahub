...
export default function SearchForm({
  ...
  return (
    <form onSubmit={handleSubmit} className={className || "relative hidden lg:block w-full max-w-[280px]"}>
      ...
      <input
        ...
        className={inputClassName || "w-full bg-gray-50 border border-gray-100 text-xs pl-9 pr-4 py-2.5 rounded-xl focus:bg-white focus:border-brand-300 focus:ring-4 focus:ring-brand-500/5 outline-none transition-all font-bold text-gray-700 placeholder:text-gray-400"}
      />
    </form>
  );
}